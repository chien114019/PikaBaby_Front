...
//	============前台API=============
	...
	List<Consignment> findAllByCustomerAndApplyDateBetweenAndProductTypeAndReview(Customer cust, Date applyStart, Date applyEnd, 
			ProductType type, Integer review);
	List<Consignment> findAllByCustomerAndApplyDateBetweenAndProductType(Customer cust, Date applyStart, Date applyEnd, ProductType type);
	List<Consignment> findAllByCustomerAndApplyDateBetweenAndReview(Customer cust, Date applyStart, Date applyEnd, Integer review);
	List<Consignment> findAllByCustomerAndApplyDateBetween(Customer cust, Date applyStart, Date applyEnd);
	List<Consignment> findAllByCustomerAndApplyDateGreaterThanEqualAndProductTypeAndReview(Customer cust, Date applyStart, ProductType pType, 
			Integer review);
	List<Consignment> findAllByCustomerAndApplyDateGreaterThanEqualAndProductType(Customer cust, Date applyStart, ProductType pType);
	List<Consignment> findAllByCustomerAndApplyDateGreaterThanEqualAndReview(Customer cust, Date applyStart, Integer review);
	List<Consignment> findAllByCustomerAndApplyDateGreaterThanEqual(Customer cust, Date applyStart);
	List<Consignment> findAllByCustomerAndApplyDateLessThanEqualAndProductTypeAndReview(Customer cust, Date applyEnd, ProductType pType, 
			Integer review);
	List<Consignment> findAllByCustomerAndApplyDateLessThanEqualAndProductType(Customer cust, Date applyEnd, ProductType pType);
