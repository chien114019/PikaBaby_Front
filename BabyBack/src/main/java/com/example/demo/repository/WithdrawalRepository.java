...
public interface WithdrawalRepository extends JpaRepository<Withdrawal, Integer>{	
	...
	List<Withdrawal> findAllByDatesAndWithdrawAndCustName(@Param("applyStart") Date applyStart, 
			@Param("applyEnd") Date applyEnd, @Param("withdrawStart") Date withdrawStart, @Param("withdrawEnd") Date withdrawEnd,
			@Param("withdraw") Integer withdraw, @Param("custName") String custName);
	
	List<Withdrawal> findAllByApplyDateBetweenAndWithdrawDateBetweenAndWithdraw(Date applyStart, Date applyEnd, Date withdrawStart, 
			Date withdrawEnd, Integer withdraw);
	...
	@Query("""
			...
			w.customer.name LIKE :custName
			""")
	List<Withdrawal> findAllByDatesAndCustName(@Param("applyStart") Date applyStart, 
			@Param("applyEnd") Date applyEnd, @Param("withdrawStart") Date withdrawStart, @Param("withdrawEnd") Date withdrawEnd,
	...
	@Query("""
			...
			w.customer.name LIKE :custName
			""")
	List<Withdrawal> findAllByApplyDateAndCustName(@Param("applyStart") Date applyStart, @Param("applyEnd") Date applyEnd, 
			@Param("custName") String custName);
	...
	List<Withdrawal> findAllByWithdrawDateAndWithdrawAndCustName(@Param("withdrawStart") Date withdrawStart, 
			@Param("withdrawEnd") Date withdrawEnd, @Param("withdraw") Integer withdraw, @Param("custName") String custName);
	...
	@Query("""
			...
			w.customer.name LIKE :custName
			""")
	List<Withdrawal> findAllByWithdrawAndCustName(@Param("withdraw") Integer withdraw, @Param("custName") String custName);
